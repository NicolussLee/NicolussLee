		...
		$.ajax({
			...
			"success": function(response) {
				...
				if (obj.length > 0) {
					...
					$(".addr_box .addr_list .addr_list_item>div").each(function() {
						$(this).click(function() {
							phon = $(this).find(".name_phone .r").text();$(this).css()
							//$(this).css("background-image", "url(../images/adderss_bg.png)").siblings().css("background-image", "url(../images/adderss_bg_1.png)")
							$('.addr_list_item>div').removeClass("active");
